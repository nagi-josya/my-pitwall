...
public sealed class ManualDriverCareerProvider : IDriverCareerProvider
{
    ...
    {
        ["Max VERSTAPPEN"] = new(2015, 129, 1, new[] { 2021, 2022, 2023, 2024 }),
        ["Lewis HAMILTON"] = new(2007, 207, 1, new[] { 2008, 2014, 2015, 2017, 2018, 2019, 2020 }),
        ["Charles LECLERC"] = new(2018, 53, 1, null),
        ["Lando NORRIS"] = new(2019, 46, 1, new[] { 2025 }),
        ["Carlos SAINZ"] = new(2015, 29, 1, null),
        ["George RUSSELL"] = new(2019, 29, 1, null),
        ["Sergio PEREZ"] = new(2011, 39, 1, null),
        ["Fernando ALONSO"] = new(2001, 106, 1, new[] { 2005, 2006 }),
        ...
        ["Kimi RAIKKONEN"] = new(2001, 103, 1, new[] { 2007 }),
        ["Sebastian VETTEL"] = new(2007, 122, 1, new[] { 2010, 2011, 2012, 2013 }),
        ["Jenson BUTTON"] = new(2000, 50, 1, new[] { 2009 }),
